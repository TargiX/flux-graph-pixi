...
const sections = [
  ...
  },
  {
    title: "Analytics",
    body:
      "Roomboard uses Vercel Web Analytics and privacy-limited PostHog product events to understand the launch funnel: landing CTA clicks, room creation, display-name setup, first card creation, uploads, comments, status changes, connector creation, invite copying, access changes, close-room actions, and recap actions. PostHog autocapture and session recording are disabled. These events avoid room names, room IDs, invite tokens, owner tokens, filenames, image URLs, display names, messages, and card content.",
  },
  {
